<template>
	<div class="heroes std-block bg-image">
		<Header></Header>
		<div class="heroes__popup">
			<div class="heroes__top">
				<div class="heroes__avatars">
					<div class="heroes__avatars__wrapper">
						<div class="heroes__avatars__item --active">
							<div class="heroes__avatars__item__img">
								<img src="../assets/img/ava1.png" alt="">
							</div>
							<div class="heroes__avatars__item__power">
								<div class="heroes__avatars__item__power__text">147 / 185</div>
								<div class="heroes__avatars__item__power__fill"></div>
							</div>
						</div>
						<div class="heroes__avatars__item">
							<div class="heroes__avatars__item__img">
							<div class="heroes__avatars__item__img__lock">
							...
							<div class="heroes__avatars__item__power">
								<div class="heroes__avatars__item__power__text">147 / 185</div>
								<div class="heroes__avatars__item__power__fill" style="width: 100%"></div>
							</div>
						</div>
						<div class="heroes__avatars__item">
							<div class="heroes__avatars__item__img">
							<div class="heroes__avatars__item__img__lock">
								...
								<img src="../assets/img/ava3.png" alt="">
							</div>
							<div class="heroes__avatars__item__power">
								<div class="heroes__avatars__item__power__text">147 / 185</div>
								<div class="heroes__avatars__item__power__fill" style="width: 100%"></div>
						...
						<div class="heroes__avatars__item">
							...
							<div class="heroes__avatars__item__img__lock">
								...
								<img src="../assets/img/ava4.png" alt="">
							</div>
							<div class="heroes__avatars__item__power">
								<div class="heroes__avatars__item__power__text">147 / 185</div>
								<div class="heroes__avatars__item__power__fill" style="width: 100%"></div>
						...
						<div class="heroes__avatars__item">
							...
							<div class="heroes__avatars__item__img__lock">
								...
								<img src="../assets/img/ava5.png" alt="">
							</div>
							<div class="heroes__avatars__item__power">
								<div class="heroes__avatars__item__power__text">147 / 185</div>
								<div class="heroes__avatars__item__power__fill" style="width: 100%"></div>
			...
			<div class="heroes__bottom">
				<div class="heroes__bottom__left">
					<div class="heroes__bottom__avatar">
						<img src="../assets/img/pers-test.png" alt="">
					...
					<div class="heroes__bottom__skills">
						...
						<div class="heroes__bottom__skills__container">
							<div class="heroes__bottom__skills__item">
					...
					<div class="heroes__bottom__upgrade">
						<div class="heroes__bottom__upgrade__name">
							Улучшить
						</div>
						<div class="heroes__bottom__upgrade__container">
							<div class="heroes__bottom__upgrade__item">
							<img src="../assets/img/skill1.png" alt="">
							<span>D</span>
						</div>
						<div class="heroes__bottom__upgrade__item">
				...
				<div class="heroes__bottom__name">
					Тревор
					<div class="heroes__bottom__level">Уровень 29</div>
				</div>
				<div class="heroes__bottom__bars">
					<div class="heroes__bottom__energy">
						<img src="../assets/img/lightning-icon.png" alt="">
						<div class="heroes__bottom__ebar">
							45 / 85
							<div class="heroes__bottom__ebar__fill"></div>
						</div>
					</div>
					...
					<div class="heroes__bottom__xp">
						...
						<div class="heroes__bottom__xpbar">
							277 / 3810
							<div class="heroes__bottom__xpbar__fill"></div>
						</div>
					</div>
				</div>
				<div class="heroes__bottom__params">
					<div class="left">
					...
					<div class="heroes__bottom__right__container">
						<div class="heroes__bottom__right__amunition">
							<div class="heroes__bottom__right__amunition__item">
								<img src="../assets/img/amu1.png" alt="">
								<div class="stat">22</div>
							</div>
							<div class="heroes__bottom__right__amunition__item">
								<img src="../assets/img/amu2.png" alt="">
								<div class="stat">22</div>
							</div>
							<div class="heroes__bottom__right__amunition__item">
								<img src="../assets/img/amu3.png" alt="">
								<div class="stat">22</div>
							</div>
							<div class="heroes__bottom__right__amunition__item">
								<img src="../assets/img/amu1.png" alt="">
						...
						<div class="heroes__bottom__right__runs hide">
							<div class="heroes__bottom__right__runs__item">
								<img src="" alt="">
								<div class="stat">22</div>
							</div>
							<div class="heroes__bottom__right__runs__item">
			...
			&__item {
				...
				&__power {
					...
					&::before {
						...
						width: 30px;
						height: 30px;
						background: url(../assets/img/lightning-icon.png) center center no-repeat;
